...
const DUMMY_BRACELETS = [
  { id: 'b1', name: 'Silver Charm Bracelet', price: '₹3,499', image: '/dummy-images/bracelet1.jpg' },
  { id: 'b2', name: 'Minimalist Cuff', price: '₹2,799', image: '/dummy-images/bracelet2.jpg' },
  { id: 'b3', name: 'Twisted Rope Bracelet', price: '₹3,199', image: '/dummy-images/bracelet3.jpg' },
  { id: 'b4', name: 'Beaded Elegance', price: '₹2,599', image: '/dummy-images/bracelet4.jpg' },
];
...
const BraceletsPage: React.FC = () => {
  ...
  return (
    <div className="container py-16 min-h-screen">
      <h1 className="text-4xl font-serif font-semibold mb-10 text-center text-gray-900">Bracelets</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        {DUMMY_BRACELETS.map((item, idx) => (
          <motion.div
            key={item.id}
